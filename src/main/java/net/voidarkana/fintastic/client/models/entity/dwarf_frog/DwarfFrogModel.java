...
public class DwarfFrogModel<T extends DwarfFrog> extends FintasticModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateIdle(entity.idleAnimationState, DwarfFrogAnims.FALLING, ageInTicks, 1.0F, Math.max(0, 1-(entity.getTicksOnGround()/20f)-(entity.getTicksOutsideWater()/3f)-Math.abs(limbSwingAmount)));
