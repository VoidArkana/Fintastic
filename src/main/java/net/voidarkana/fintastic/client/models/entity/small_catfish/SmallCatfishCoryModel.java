...
public class SmallCatfishCoryModel<T extends SmallCatfish> extends FintasticModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateIdle(entity.idleAnimationState, SmallCatfishCorysAnims.TINY_CORY_POSE_BTM, ageInTicks, 1.0f, Math.max(0, (entity.getTicksOnGround()/3f)-(entity.getTicksOutsideWater()/3f)));
