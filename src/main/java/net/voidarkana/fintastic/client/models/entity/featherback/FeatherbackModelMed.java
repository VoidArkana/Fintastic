...
public class FeatherbackModelMed<T extends Featherback> extends FintasticModel<T> {
	...
	public FeatherbackModelMed(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = swim_control.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -4.0F, -3.0F, 3.0F, 7.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(0, 22).addBox(0.0F, -1.0F, 2.0F, 0.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, -3.0F, -3.0F));

		PartDefinition dorsalfin = body.addOrReplaceChild("dorsalfin", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -3.0F, 0.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, 5.0F));

		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(16, 0).addBox(-1.0F, -2.0F, -5.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -3.0F));

		PartDefinition fin_fr = body.addOrReplaceChild("fin_fr", CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 3.0F, -2.0F));

		PartDefinition fin_fl = body.addOrReplaceChild("fin_fl", CubeListBuilder.create().texOffs(0, 4).addBox(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, 3.0F, -2.0F));

		PartDefinition tail_rot = body.addOrReplaceChild("tail_rot", CubeListBuilder.create(), PartPose.offset(0.0F, -2.5F, 7.0F));

		PartDefinition tail = tail_rot.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(13, 8).addBox(0.0F, -3.5F, 2.0F, 0.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(0, 17).addBox(-1.0F, -1.5F, 0.0F, 2.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
