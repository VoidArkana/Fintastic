...
public class FintyConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, HORNWORT_KEY, FintyConfiguredFeatures.HORNWORT_FEATURE.get(), FeatureConfiguration.NONE);
        ...
        register(context, GREEN_ALGAE_PATCH_BONEMEAL, ALGAE_PATCH_FEATURE.get(),
                new VegetationPatchConfiguration(FintyTags.Blocks.ALGAE_REPLACEABLE, BlockStateProvider.simple(FintyBlocks.GREEN_ALGAE_BLOCK.get()),
        ...
        register(context, RED_ALGAE_PATCH_BONEMEAL, ALGAE_PATCH_FEATURE.get(),
                new VegetationPatchConfiguration(FintyTags.Blocks.ALGAE_REPLACEABLE, BlockStateProvider.simple(FintyBlocks.RED_ALGAE_BLOCK.get()),
        ...
        register(context, LIVE_ROCK_BOULDER, LIVE_ROCK_BOULDER_FEATURE.get(),
                new LiveRockBoulderConfig(BlockStateProvider.simple(FintyBlocks.RED_ALGAE_LIVE_ROCK.get()),
                        BlockStateProvider.simple(FintyBlocks.GREEN_ALGAE_LIVE_ROCK.get()), 0.6F,
                        PlacementUtils.inlinePlaced(holdergetter.getOrThrow(RED_ALGAE_VEGETATION)),
                        PlacementUtils.inlinePlaced(holdergetter.getOrThrow(GREEN_ALGAE_VEGETATION))));


        WeightedStateProvider stromatoliteWSP = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
                .add(FintyBlocks.STROMATOLITE_GROWTHS.get().defaultBlockState().setValue(StromatoliteBlock.WATERLOGGED, false), 10)
                .add(FintyBlocks.STROMATOLITE.get().defaultBlockState().setValue(StromatoliteBlock.WATERLOGGED, true), 4));
        ...
        register(context, STROMATOLITE_PATCH, STROMATOLITE_PATCH_FEATURE.get(),
                new VegetationPatchConfiguration(FintyTags.Blocks.STROMATOLITE_REPLACEABLE,
                        BlockStateProvider.simple(FintyBlocks.STROMATOLITE_BLOCK.get()),
        ...
        WeightedStateProvider fossilStromatoliteWSP = new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
                .add(FintyBlocks.FOSSIL_STROMATOLITE_GROWTHS.get().defaultBlockState().setValue(StromatoliteBlock.WATERLOGGED, false), 10)
                .add(FintyBlocks.FOSSIL_STROMATOLITE.get().defaultBlockState().setValue(StromatoliteBlock.WATERLOGGED, true), 4));
        ...
        register(context, FOSSIL_STROMATOLITE_PATCH, STROMATOLITE_PATCH_FEATURE.get(),
                new VegetationPatchConfiguration(FintyTags.Blocks.FOSSIL_STROMATOLITE_REPLACEABLE,
                        BlockStateProvider.simple(FintyBlocks.FOSSIL_STROMATOLITE_BLOCK.get()),
