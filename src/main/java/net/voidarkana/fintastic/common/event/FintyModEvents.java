...
public class FintyModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event){
        ...
        if (event.getType() == FintyVillagerProfessions.AQUARIST.get()){
            ...
            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyBlocks.DUCKWEED.get(), 20),
                    new ItemStack(Items.EMERALD, 1),
                    10, 8, 0.02f));

            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyBlocks.HORNWORT.get(), 20),
                    new ItemStack(Items.EMERALD, 1),
                    10, 8, 0.02f));

            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyBlocks.ANUBIAS.get(), 10),
                    new ItemStack(Items.EMERALD, 1),
                    10, 8, 0.02f));

            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyBlocks.CAULERPA.get(), 10),
                    new ItemStack(Items.EMERALD, 1),
                    10, 8, 0.02f));

            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyBlocks.SEA_GRAPES.get(), 20),
                    new ItemStack(Items.EMERALD, 1),
                    10, 8, 0.02f));
        ...
        if (event.getType() == VillagerProfession.FISHERMAN){
            ...
            //level 1
            trades.get(1).add((trader, random) -> new MerchantOffer(
                    new ItemCost(FintyItems.RAW_FISH.get(), 6),
                    new ItemStack(Items.EMERALD, 1),
                    5, 9, 0.035f));
    ...
    private static final ResourceKey<StructureProcessorList> EMPTY_PROCESSOR_LIST_KEY = ResourceKey.create(
            Registries.PROCESSOR_LIST, ResourceLocation.parse("minecraft:empty"));
