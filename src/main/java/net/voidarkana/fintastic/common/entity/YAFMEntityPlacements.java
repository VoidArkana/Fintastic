...
public class YAFMEntityPlacements {
    public  static void entityPlacement() {
        SpawnPlacements.register(YAFMEntities.SHARKMINNOW.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules);
        ...
        SpawnPlacements.register(YAFMEntities.GOURAMI.get(), SpawnPlacements.Type.IN_WATER, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WaterAnimal::checkSurfaceWaterAnimalSpawnRules);
    }
}
