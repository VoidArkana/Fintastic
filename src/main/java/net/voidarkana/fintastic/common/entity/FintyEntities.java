...
public class FintyEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, Fintastic.MOD_ID);

    public static final Supplier<EntityType<Featherback>> FEATHERBACK =
    ...
    //update 2.0
    public static final Supplier<EntityType<Moony>> MOONY =
