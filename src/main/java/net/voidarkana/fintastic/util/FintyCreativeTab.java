    ...
    public static final Supplier<CreativeModeTab> YAFM_CREATIVE_TAB =
            CREATIVE_MODE_TABS.register("fintastic_creative_tab", ()-> CreativeModeTab.builder().icon(() -> new ItemStack(FintyItems.FEATHERBACK.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(FintyBlocks.WHITE_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.WHITE_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.LIGHT_GRAY_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.LIGHT_GRAY_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.GRAY_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.GRAY_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.BLACK_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.BLACK_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.BROWN_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.BROWN_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.RED_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.RED_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.ORANGE_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.ORANGE_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.YELLOW_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.YELLOW_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.LIME_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.LIME_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.GREEN_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.GREEN_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.CYAN_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.CYAN_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.LIGHT_BLUE_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.LIGHT_BLUE_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.BLUE_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.BLUE_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.PURPLE_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.PURPLE_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.MAGENTA_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.MAGENTA_AQUARIUM_GLASS_PANE.get());
                        output.accept(FintyBlocks.PINK_AQUARIUM_GLASS.get());
                        output.accept(FintyBlocks.PINK_AQUARIUM_GLASS_PANE.get());
